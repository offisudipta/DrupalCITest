...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal7CI_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_drupal7CI_dd.inc';
}
// </DDSETTINGS>
...
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/s6012b8242b7af/s6012b8242b7af-settings.inc');
}
